...
function decodeStrict(input, options = EntityLevel.XML) {
  ...
  (_a2 = normalizedOptions.mode) !== null && _a2 !== void 0 ? _a2 : normalizedOptions.mode = DecodingMode.Strict;
...
function encode(input, options = EntityLevel.XML) {
  ...
  switch (mode) {
    ...
    case EncodingMode.ASCII: {
      return level === EntityLevel.HTML ? encodeNonAsciiHTML(input) : encodeXML(input);
    }
